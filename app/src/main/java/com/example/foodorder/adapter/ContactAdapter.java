...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ContactViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ContactViewHolder holder, int position) {
        ...
        switch (contact.getId()) {
            ...
            case Contact.GMAIL:
                holder.mItemContactBinding.tvContact.setText("Chat with GPT");
                break;

            case Contact.SKYPE:
                holder.mItemContactBinding.tvContact.setText("Logout");
                break;
            ...
            case Contact.ZALO:
                holder.mItemContactBinding.tvContact.setText("Location");
                break;
        }
