...
import com.example.foodorder.activity.ChatActivity;
import com.example.foodorder.activity.MapsActivity;
import com.example.foodorder.activity.SignIn;
...
//        context.startActivity(Intent.createChooser(emailIntent, "Send Email"));
        Intent sIntent = new Intent(context, ChatActivity.class);
    ...
    public static void onClickOpenZalo(Context context) {
        Intent sIntent = new Intent(context, MapsActivity.class);
        context.startActivity(sIntent);
    }
    ...
    public static void logout(Context context){
        Paper.book().destroy();
        Intent sIntent = new Intent(context, SignIn.class);
